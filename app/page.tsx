    ...
    <main className="presentation">
      <div className="slideTrack" style={{ transform: `translateX(-${currentSlide * 100}vw)` }}>
        ...
        <section className="slide conceptSlide conceptGenerative" aria-labelledby="limits-title">
          <div className="conceptGlow" aria-hidden="true" />
          <header className="topbar conceptTopbar"><div className="brand"><span className="brandMark" aria-hidden="true"><span>&lt;</span><i /><span>/&gt;</span></span><span className="brandText">WEB · IA</span></div><p className="edition">Proyecto 1</p></header>
          <div className="conceptContent"><div className="conceptLead"><p className="eyebrow"><span />Diapositiva 27</p><h2 id="limits-title">Límites claros,<br />diseño <em>propio.</em></h2><p>Hay condiciones que no cambian y decisiones que pueden evolucionar durante el desarrollo.</p></div><div className="comparisonCards"><article><span className="comparisonTag">Restricciones estables</span><h3>Lo obligatorio</h3><p>Experiencia individual, sin cuentas, sin privacidad ni aislamiento por usuario, con las acciones de crear, ver, editar y eliminar tareas.</p><small>El gestor no será multiusuario en esta etapa.</small></article><article className="agentCard"><span className="comparisonTag">Decisiones evolutivas</span><h3>Lo que podés diseñar</h3><p>Colores, layout, campos extra, categorías, filtros, orden y detalles de interacción.</p><small>La creatividad aparece dentro de los límites del problema.</small></article></div></div>
        ...
        <section className="slide proposalSlide proposalArchitecture" aria-labelledby="three-parts-title">
          <div className="proposalGlow" aria-hidden="true" />
          <header className="topbar proposalTopbar"><div className="brand"><span className="brandMark" aria-hidden="true"><span>&lt;</span><i /><span>/&gt;</span></span><span className="brandText">WEB · IA</span></div><p className="edition">Proyecto 1 · Diseño</p></header>
          <div className="proposalContent"><div className="proposalLead"><p className="eyebrow"><span />Diapositiva 28</p><h2 id="three-parts-title">Tres partes,<br />una <em>aplicación.</em></h2><p>Para construir el gestor de tareas, vamos a dividir la aplicación en tres aspectos que se conectan entre sí.</p></div><div className="architectureStack"><article><span>01 · Interfaz</span><h3>Lo que el usuario ve y utiliza</h3><p>La pantalla, el formulario, la lista de tareas, los botones y los mensajes.</p></article><i aria-hidden="true">↓</i><article><span>02 · Lógica</span><h3>Las decisiones de la aplicación</h3><p>Las reglas para crear, ver, editar, completar y eliminar tareas.</p></article><i aria-hidden="true">↓</i><article><span>03 · Almacenamiento</span><h3>El lugar donde quedan los datos</h3><p>Primero en el navegador; luego, en una base de datos.</p></article></div></div>
          <footer className="footer proposalFooter"><p>Interfaz → Lógica → Almacenamiento</p><div className="slideNumber" aria-label="Diapositiva 28 de 34"><span>28</span><i /></div></footer>
        </section>

        <section className="slide conceptSlide conceptModels" aria-labelledby="stack-title">
          <div className="conceptGlow" aria-hidden="true" />
          <header className="topbar conceptTopbar"><div className="brand"><span className="brandMark" aria-hidden="true"><span>&lt;</span><i /><span>/&gt;</span></span><span className="brandText">WEB · IA</span></div><p className="edition">Proyecto 1</p></header>
          <div className="conceptContent"><div className="conceptLead"><p className="eyebrow"><span />Diapositiva 29</p><h2 id="stack-title">Primero local;<br />después <em>conectado.</em></h2><p>Avanzaremos por etapas para validar la experiencia antes de incorporar persistencia en la nube.</p></div><div className="conceptFlow"><article><span className="flowTag">Etapa 1</span><h3>localStorage</h3><p>Las tareas se guardan en el navegador para construir y probar el flujo completo.</p></article><i>→</i><article><span className="flowTag">Etapa 2</span><h3>Supabase</h3><p>Luego migraremos la persistencia a una base de datos.</p></article><i>→</i><article><span className="flowTag">Durante el desarrollo</span><h3>MCP</h3><p>Usaremos MCP para conectar herramientas y acompañar el proceso de desarrollo.</p></article></div></div>
          <footer className="footer conceptFooter"><p>Probar · Persistir · Evolucionar</p><div className="slideNumber" aria-label="Diapositiva 29 de 34"><span>29</span><i /></div></footer>
        </section>
        ...
        <section className="slide proposalSlide proposalData" aria-labelledby="data-title">
          ...
          <div className="proposalContent proposalSingle"><div className="proposalLead"><p className="eyebrow"><span />Diapositiva 33</p><h2 id="data-title">El mismo flujo;<br /><em>otro destino.</em></h2><p>La interfaz y la lógica se mantienen. Lo que cambia es dónde viajan y permanecen las tareas.</p></div><div className="dataCompare"><article><span>Etapa 1 · localStorage</span><h3>Datos en el navegador</h3><div className="dataFlow"><b>Interfaz</b><i>→</i><b>Lógica</b><i>→</i><b>localStorage</b></div><p>Ideal para validar el recorrido sin depender de un servicio externo.</p></article><article><span>Etapa 2 · Supabase</span><h3>Datos en la nube</h3><div className="dataFlow"><b>Interfaz</b><i>→</i><b>Lógica</b><i>→</i><b>Supabase</b></div><p>Permite persistir datos en una base de datos y preparar la siguiente evolución.</p></article></div></div>
          <footer className="footer proposalFooter"><p>El flujo se conserva · La persistencia evoluciona</p><div className="slideNumber" aria-label="Diapositiva 33 de 34"><span>33</span><i /></div></footer>
        </section>
        ...
        <section className="slide proposalSlide proposalMcp" aria-labelledby="mcp-title">
          ...
          <div className="proposalContent"><div className="proposalLead"><p className="eyebrow"><span />Diapositiva 34</p><h2 id="mcp-title">MCP conecta<br />a <em>OpenCode.</em></h2><p>MCP forma parte del proceso de desarrollo: no es una capa de la aplicación que usará la persona.</p></div><div className="mcpPanel"><div className="mcpConnection"><article><span>OpenCode</span><p>El agente trabaja sobre el proyecto.</p></article><i aria-hidden="true">⇄</i><article><span>MCP</span><p>Conecta herramientas autorizadas durante el desarrollo.</p></article><i aria-hidden="true">⇄</i><article><span>Servicios</span><p>Por ejemplo, Supabase cuando corresponda.</p></article></div><div className="decisionSplit"><p><b>Se mantiene:</b> las acciones de crear, ver, editar y eliminar tareas, la experiencia individual y la separación de capas.</p><p><b>Se revisa:</b> layout, campos, textos, detalles visuales y decisiones que validemos en el camino.</p></div></div></div>
          <footer className="footer proposalFooter"><p>Desarrollar con herramientas · Revisar con evidencia</p><div className="slideNumber" aria-label="Diapositiva 34 de 34"><span>34</span><i /></div></footer>
        </section>
      </div>
